...
![](/img/user/体系结构与操作系统/虚拟化/系统虚拟化：原理与实现/assets/boxcnmcPm86HDg1KG2WVrRce5nr.png)
...
![](/img/user/体系结构与操作系统/虚拟化/系统虚拟化：原理与实现/assets/boxcncCDn0b4zRfBqRl8mIs8nAc.png)

VMCS主要信息存放在数据域。可以使用VMREAD <INDEX>和VMWRITE <INDEX> <DATA>访问指定索引的数据域。

![](/img/user/体系结构与操作系统/虚拟化/系统虚拟化：原理与实现/assets/boxcngVCBvpclHqQSi7w7CN7huu.png)
...
![](/img/user/体系结构与操作系统/虚拟化/系统虚拟化：原理与实现/assets/boxcnBl97nmo5HzH3XEbLxFudCb.png)
...
![](/img/user/体系结构与操作系统/虚拟化/系统虚拟化：原理与实现/assets/boxcneG3ivGOduxzhejjj3xEUGb.png)
...
![](/img/user/体系结构与操作系统/虚拟化/系统虚拟化：原理与实现/assets/boxcnDiNGXkKf8YpambjvsSyL2e.png)
...
![](/img/user/体系结构与操作系统/虚拟化/系统虚拟化：原理与实现/assets/boxcn7swQC0y04jelI2sEcAUyeg.png)
...
![](/img/user/体系结构与操作系统/虚拟化/系统虚拟化：原理与实现/assets/boxcnq8MZskbCuBzd537VkGX7Fh.png)
...
![](/img/user/体系结构与操作系统/虚拟化/系统虚拟化：原理与实现/assets/boxcnuZ0PRMAjnQENZI7KexGcdh.png)



![](/img/user/体系结构与操作系统/虚拟化/系统虚拟化：原理与实现/assets/boxcnevla6ou6ascOiw2pydeAhg.png)
