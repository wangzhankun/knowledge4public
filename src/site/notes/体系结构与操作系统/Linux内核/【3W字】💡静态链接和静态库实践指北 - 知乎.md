...
objdump -h -j .text libxxx.so <br> readelf -l libxxx.so <br> objdump -R ibxxx.so |
...
objdump -h -j .text xxx_exe <br> readelf -l xxx_exe <br> ldd xxx_exe <br> objdump -R xxx_exe |
