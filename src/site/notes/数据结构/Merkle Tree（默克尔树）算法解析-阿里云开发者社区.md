---
{"dg-publish":true,"date":"2023-12-08","time":"19:34","progress":"完成","tags":["数据结构/树"],"permalink":"/数据结构/Merkle Tree（默克尔树）算法解析-阿里云开发者社区/","dgPassFrontmatter":true}
---



# Merkle Tree（默克尔树）算法解析-阿里云开发者社区
...
1. 非叶子节点的value是根据它下面所有的叶子节点值，然后按照Hash算法计算而得出的。[4][5]
...
[2] [https://en.wikipedia.org/wiki/Hash_function#Hash_function_algorithms](https://en.wikipedia.org/wiki/Hash_function#Hash_function_algorithms)

[3] [http://www.jianshu.com/p/458e5890662f](http://www.jianshu.com/p/458e5890662f)

[4] [http://blog.csdn.net/xtu_xiaoxin/article/details/8148237](http://blog.csdn.net/xtu_xiaoxin/article/details/8148237)

[5] [http://blog.csdn.net/yuanrxdu/article/details/22474697?utm_source=tuicool&utm_medium=referral](http://blog.csdn.net/yuanrxdu/article/details/22474697?utm_source=tuicool&utm_medium=referral)
...
[9] [http://bittorrent.org/beps/bep_0030.html](http://bittorrent.org/beps/bep_0030.html)
